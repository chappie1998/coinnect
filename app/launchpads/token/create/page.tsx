...
import { BytesLike, ContractFactory, Wallet } from "fuels";
...
export default function create() {
  ...
  const deployContract = async () => {
    ...
    const data = await fetch("lool/sway_contracts/src-20/out/debug/src-20.bin");
    ...
    const abi = require("/sway_contracts/src-20/out/debug/src-20-abi.json");
    console.log(abi);
